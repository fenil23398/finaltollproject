...
var trans={
   ...
   addTransaction:function(tt,callabck){
        return db.query("insert into transaction values(?,?,?,?,?,?,?,?,?,?)",[null,tt.user_id,tt.payment_id,tt.vehicle_no,tt.toll_plaza_id,tt.transaction_date,tt.transaction_time,tt.status,tt.amount,tt.isreturn],callabck);
   },
